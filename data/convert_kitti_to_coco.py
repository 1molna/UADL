...
def create_coco_lists(
    ...
    for image_id in ids_list:
        ...
        images_list.append({'id': int(image_id),
                            'width': image.shape[1],
        ...
        for bbox, category_name in zip(frame_boxes, category_names):
            ...
            annotations_list.append({'image_id': int(image_id),
                                     'id': count,
...
def main(args):
    ...
    categories_to_use = ('car', 'pedestrian','van','truck','person_sitting','cyclist','tram')
    ...
    categories = [{'id': 1, 'name': 'car', 'supercategory': 'vehicle'},
                  ...
                  {'id': 5, 'name': 'person_sitting', 'supercategory': 'vehicle'},
                  {'id': 6, 'name': 'cyclist', 'supercategory': 'vehicle'},
                  {'id': 7, 'name': 'tram', 'supercategory': 'vehicle'},
                  {'id': 8, 'name': 'misc', 'supercategory': 'vehicle'},
                  {'id': 9, 'name': 'dontCare', 'supercategory': 'vehicle'}
                  ]#,
    ...
    print("Converted kitti to COCO format!")
